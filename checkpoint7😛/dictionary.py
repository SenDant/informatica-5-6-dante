...
#------------------------------------------------- GETTING THE VALUE OF EVERY DICTIONARY'S KEY WITH A FOR LOOP
# houses = {
#     "Hermione": "Gryffindor",
#     "Harry": "Gryffindor",
#     "Ron": "Gryffindor",
...
#------------------------------------------------- (MORE COMPLEX EXAMPLE): USING MATRIX TO GET +2 ELEMENTS
...
for student in student_info:
    print(f"{student["Name"]}'s house: {student["House"]}. Favorite Patronus: {student["Patronus"]}") #checking through every element(dictionary) and using the
